 ...
 * of the latest private chat histories(listed in old to new order)
 * between the caller and the other user
 *
 ...
 *  'is_your_message' : you sent it -> 1, you received it -> 0
        ...
        models.User.find({_id: other_user_id},function (err, users) {
            ...
            if (!users){
                ...
                models.ChatHistory.find({
                    ...
                    // change order from new->old to old->new
                    //tempJsonAry.reverse();
