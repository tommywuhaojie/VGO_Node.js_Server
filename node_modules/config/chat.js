    ...
    if(!my_user_id) {
        ...
        models.User.find({_id: other_user_id},function (err, users) {
            ...
            if (!users) {
                ...
                callback({
                    code: "-4",
                    msg: "other_user_id does not exist in database",
                });
                return;
                ...
                callback({
                    code: "-5",
                    msg: "You already added this contact, you cannot add it again",
                });
                return;
...
exports.getContactList = function(sess, callback) {
    ...
    if(!my_user_id){
        jsonAry.push({code: "-1", msg: "Failed to authenticate, please login first", number_of_contact: "0"});
        callback(jsonAry);
        return;
    }else{
