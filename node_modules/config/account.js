 ...
 *
 * INPUT:
 * 'my_info': '1' -> get user info of current logged-in user (myself) '0' or leave it empty -> get user info by following two identification
...
exports.getUserInfo = function(phone_number, user_id, callback) {
